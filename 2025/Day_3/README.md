...
-   In `_98_7654321111111`, you can make the largest joltage possible, *`98`*, by turning on the first two batteries.
-   In `_8_1111111111111_9_`, you can make the largest joltage possible by turning on the batteries labeled `8` and `9`, producing *`89`* jolts.
-   In `2342342342342_78_`, you can make *`78`* by turning on the last two batteries (marked `7` and `8`).
